 ...
 <div class="Quiz-Template2 start_temp_outer quiz_comon_template" style="min-height: 200px;">
	<div class="Quiz-Template-title sqb_tiny_mce_editor"><div>Enter the Quiz Title</div></div>	
	...
	<span class="sqbShowStartTemplateImageOuter"><button class="sqbShowStartTemplateImage">Show Image</button></span>
	<div class="question_img_div " id="start_img_temp2" style="display:none">	 
		<!--span class="sqb_backend_show sqb_remove_section" data-id="start_img_temp2" ><i class="fa fa-trash-o" aria-hidden="true"></i></span-->
		<img class="start_img sqb_img_draggable"  src="<?php echo plugins_url('');?>/smartquizbuilder/includes/images/start_image1.jpg" style="height: 370px;">
	...
	<div class="Quiz-Template-content">
		<div class="sqb_tiny_mce_editor sqb_content"><div style="text-align:center;"> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it.</div></div>  
		
		<div class="take-quiz-btn sqb_tiny_mce_editor " style="color:rgb(255, 255, 255);max-width: 700px"><div>TAKE THIS QUIZ</div></div>		 								
	</div>	 
</div>
