<div class="outcome-section Quiz-Template9-column-wrapper sqb-template-bg-video-left sqb-no-video-found">
	<div class="outcome-Screen-Quiz-Template9-left-side Quiz-Template9-left-column-wrapper">
		
	</div>

	<div class="outcome-Screen-Quiz-Template9-right-side Quiz-Template9-right-column-wrapper">
		<div class="Quiz-Template result_temp_outer personality_temp quiz_comon_template outer-style9"> 
			<div class="points_scored_result sqb_outcome_tiny_mce_editor   " ><div>Your Result Type is [Outcome_Title]</div> </div> 
			...
			<div class="question_img_div Quiz-Template-image img_outer" id="result_temp_id" style="display:none;">
				<!--span class="sqb_backend_show sqb_remove_section" data-id="result_temp_id"><i class="fa fa-close" aria-hidden="true"></i></span-->
				
				<img class="%%CURRENTDATETIMERANDOMIMG%% sqb_img_draggable" src="%%IMGURL%%">
				<span data-class="%%CURRENTDATETIMERANDOMIMG%%" class="question_img_upload sbq_change_img "><i class="fa fa-camera" aria-hidden="true"></i></span>
			</div>
			...
			<div class="Quiz-Template-content">
				...
				<div class="Quiz-Template-content-inn pos_relative " id="result_temp_contentid">
					<div class="sqb_outcome_tiny_mce_editor" ><div>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</div></div><br>
				</div>
				<div class="Quiz-Template-content-inn pos_relative" id="result_temp_btnid">
					<div class="d-inline-block pos_relative">
						...
						<div class="take-quiz-btn sqb_outcome_tiny_mce_editor" ><div>Continue</div></div>
					</div>				
				</div>	 
			</div>	 
		</div>
